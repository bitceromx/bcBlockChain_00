...
async function initContractFromOrg1Identity() {
    ...
    const caOrg1Client = buildCAClient(FabricCAServices, ccpOrg1, 'ica.org1.example.com');
    //console.log('caOrg1Client--->',caOrg1Client);
...
async function main() {
    try {
        ...
        try {
            ...
            let result;
            let asset1Data = { objectType: assetType, assetID: assetID1, nombre: 'Pedro', apaterno: 'Ruiz', amaterno: 'Lopez', appraisedValue: 100 };
            let asset2Data = { objectType: assetType, assetID: assetID2, nombre: 'Alejandra', apaterno: 'Avila', amaterno: 'Rojas', appraisedValue: 727 };
