...
PEERPEM=../organizations/peerOrganizations/org3.example.com/tlsca/chain.tls.org3.example.com.cert

##CAPEM=../organizations/peerOrganizations/org3.example.com/ca/ca.org3.example.com-cert.pem
CAPEM=../organizations/peerOrganizations/org3.example.com/ca/chain.identity.org3.example.com.cert
